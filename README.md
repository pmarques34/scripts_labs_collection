...
Mas a mágica aqui vai além do resultado final.

A ideia é passar tempo codando, quebrando coisas, debugando, entendendo o problema de verdade e reconstruindo a solução do zero. É nesse processo que o aprendizado acontece — não só no script pronto.
...
Código escrito como parte do meu treino em scripting e pentest

Soluções criadas durante estudos, labs e desafios

Ideias simples, outras nem tanto, todas com propósito didático
...
Commit direto na main não rola — até eu preciso me proteger de mim mesmo
